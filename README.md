...
นี่เป็นภาษา opal_Inwza007x ถ้าไม่เข้าใจ ก็ไปถาม [opal_Inwza007x](https://www.facebook.com/profile.php?id=100002974790342) แล้วก็ตัวฟ้าๆกดได้นะครับ เป็นเรื่องเพิ่มเติม
...
${\color{green}binary}$ ${\color{green}search}$
...
${\color{green}lower }$ ${\color{green}bound }$ ${\color{green}and }$ ${\color{green}upper }$ ${\color{green}bound}$
